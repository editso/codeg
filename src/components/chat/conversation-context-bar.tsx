...
export const ConversationFolderBranchPicker = memo(
  function ConversationFolderBranchPicker({
    ...
    // look locked after a restart. Non-tab surfaces use their explicit
    // editability contract instead.
    const projectChangeLocked = override
      ? !override.editable
      : !isNewConversation &&
        (liveConnectionStatus === "prompting" ||
          liveConnectionStatus === "connecting" ||
          (liveConnectionStatus === undefined &&
            ownTab!.status === "in_progress"))
