    ...
    pub fn run() {
        ...
        builder
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                conversations::rebind_conversation_project,
                conversations::get_conversation_config,
                conversations::get_draft_conversation_mcp_catalog,
                conversations::update_conversation_config,
                conversations::update_conversation_session_config_value,
                ...
                folders::update_project_location,
